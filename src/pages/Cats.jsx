...
export default function Cats() {
  ...
  return (
    <section className="bg-[#fffff6] min-h-screen px-4 sm:px-8 lg:px-12 py-12">
      <div className="max-w-6xl mx-auto">
        <h1
          className="text-3xl sm:text-4xl font-black text-[#add3fa] mb-8"
          ...
          {cats.map((cat) => (
            ...
            >
              ...
              <div className="p-4 flex flex-col gap-2 flex-1">
                <h3 className="text-xl font-bold text-[#464646]">{cat.name}</h3>
                <p className="text-sm text-[#464646]">Gender: {cat.gender}</p>
                <p className="text-sm text-[#464646]">Breed: {cat.breed}</p>
                <button
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full mt-1 border border-gray-300 rounded-lg px-3 py-2 min-h-[80px]"
                  />
